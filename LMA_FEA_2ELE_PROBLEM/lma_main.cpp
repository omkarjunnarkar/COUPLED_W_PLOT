...
void main() {
	...
	MatrixXd Parameters = LevenbergMarquardtFit(parameters_guess, initial_deflection, y_measured, area_1, area_2, len_1, len_2, t_total, ForceMax);

	cout << "Parameters = \n" << Parameters << endl;

	ofstream myfitfile("final_fit.csv");

	MatrixXd final_fit = function_y(Parameters,  area_1,  area_2,  len_1,  len_2,  t_total,  ForceMax);
